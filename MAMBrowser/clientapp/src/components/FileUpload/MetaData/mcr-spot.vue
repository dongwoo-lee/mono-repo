<template>
  <div>
    <div style="position:absolute; top:30px;">
      ...
      <button
        v-show="!isActive"
        style="position:relative; right:-210px; top:-7px;  z-index:9999; width:3px;  background-color:#FFFFFF; border:0; outline:0;"
      >
        <b-icon
          icon="x-circle"
          font-scale="1"
      ...
      <b-form-group
        label="매체"
        class="has-float-label"
        style="position:absolute; top:0px; margin-left:320px; z-index:9999;"
      >
        <b-form-select
          :disabled="isActive"
          id="program-media"
      ...
      <b-button
        :disabled="isActive"
        :variant="getVariant"
        style="position:absolute; width:70px; right:0px; z-index:9989; "
        @click="getPro"
        >검색</b-button
      >
    ...
    border: 1px solid #008ecc;"
      ...
      <div
        ...
        style="width: 550px; height:80px; margin-top:60px; padding-left:10px; padding-right:10px; float:left; border:1px solid #008ecc;"
      >
