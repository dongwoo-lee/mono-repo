...
<script>
import CommonMetaModalUX from "../Modal/CommonMetaModalUX";
import MixinBasicPage from "../../mixin/MixinBasicPage";
import CommonVueSelect from "../Form/CommonVueSelect.vue";
import myDisk from "./MetaData copy/my-diskux.vue";
import program from "./MetaData copy/programux.vue";
import pro from "./MetaData copy/proux.vue";
import mcrSpot from "./MetaData copy/mcr-spotux.vue";
import scrSpot from "./MetaData copy/scr-spotux.vue";
import staticSpot from "./MetaData copy/static-spotux.vue";
import varSpot from "./MetaData copy/var-spotux.vue";
import report from "./MetaData copy/coverageux.vue";
import filler from "./MetaData copy/fillerux.vue";
