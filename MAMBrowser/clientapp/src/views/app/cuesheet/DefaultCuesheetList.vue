<template>
  <div>
    <b-row>
      <b-colxx xxs="12">
        <piaf-breadcrumb heading="기본 큐시트 작성" />
    ...
    >
      ...
      <template slot="form-search-area">
        <!-- 채널 -->
        <b-form-group label="채널" class="has-float-label">
          <b-form-select
            class="width-140"
      ...
      <template slot="form-btn-area">
        <b-input-group>
          <b-button variant="outline-primary default" size="sm"
            >기본 큐시트 추가</b-button
          >
        </b-input-group>
        <b-input-group>
      ...
      <template slot="form-table-area">
        ...
        >
          <template slot="actions">
            <common-actions :cuesheetData="true"> </common-actions>
          </template>
        </common-data-table-scroll-paging>
      </template>
    </common-form>
