<template>
  <div class="overView">
    <div id="cuesheet_view">
      <div class="toolDiv">
        <div class="schdiv">
          <div id="schtitleText" class="mt-4">
            소재검색
            <span id="subtitleDiv" class="ml-3">
            ...
            <div class="schsch" v-if="menuitem_id != '4_1'">
              ...
              <div class="ml-5">
                <div class="subjectListDiv mt-3 mb-3">
                  <span class="subjectList mr-2">대분류 :</span>
                  <DxSelectBox
                    ...
                    height="35px"
                  />
                  <span class="subjectList mr-2">소분류 :</span>
                  <DxSelectBox
                    ...
                    height="35px"
                  />
                  <span class="subjectList mr-2">검색옵션 :</span>
                  <DxSelectBox
                    class="subjectList mr-3"
                    :items="subjectList_o"
                ...
                <div class="subjectListDiv mt-3 mb-3">
                  <span class="subjectList mr-2">검색어 :</span>
                  <DxTextBox
                    placeholder=""
                    class="subjectList mr-2"
                    width="250px"
          ...
          <div class="schseparator mb-3"></div>
          <div class="schtext">전체 : 152 건</div>
          <div class="schtable">
            <DxDataGrid
        ...
        <div id="subtitleDiv">
          ...
          <span class="subTitle">|</span>
          <span class="subTitle">기본 큐시트 작성</span>
        </div>
        <div class="weekDiv">
          <span class="week4 black2">화</span>
          <span class="week4 black2">목</span>
          <span class="week4 black2">금</span>
          <span class="week4 black2">토</span>
          <span class="week4 black2">일</span>
          <span>
            <DxButton
              id="weekcancelBtn"
              text="변경"
            ...
            <div id="modelDiv" class="d-block text-center">
              <div class="weekBtn2">
                <div class="testclass3">
                  <span class="week5">화</span>
                  <span class="week5">목</span>
                  <span class="week5">금</span>
                  <span class="week5">토</span>
                  <span class="week5">일</span>
                </div>
                <div class="testclass4">
                  <DxCheckBox class="week6" :value="true" />
                  <DxCheckBox class="week6" :value="true" />
                  <DxCheckBox class="week6" :value="true" />
                  <DxCheckBox class="week6" :value="true" />
                  <DxCheckBox class="week6" :value="true" />
        ...
        <button
          ...
          @click="itemfindOn"
        >
          <b-icon-search></b-icon-search>소재검색
        </button>
        <div class="buttonDiv">
          <button type="button" class="btn btn-outline-primary btn-lg">
            <b-icon-check-circle></b-icon-check-circle>큐시트 저장
          </button>
          <button
            type="button"
            id="listbtn"
...
export default {
  ...
  methods: {
    OnsyncData() {
      ...
      const arr = this.channelAB.filter((item) => item.duration);
      console.log(arr);
...
#weekcancelBtn .dx-button-content {
  padding: 4px;
}
.black2 {
