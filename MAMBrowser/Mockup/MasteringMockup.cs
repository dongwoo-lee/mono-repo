...
namespace MAMBrowser.Mockup
{
    ...
    {
        public DTO_SONG_CASHE SongMastering(DTO_SONG song)
        {
            Thread.Sleep(2000);
            string code = "SM01";
            string code2 = "SS01";
            ...
            DTO_SONG_CASHE songCacheDTO = new DTO_SONG_CASHE();
        ...
        public DTO_SONG_CASHE EffectMastering(DTO_EFFECT effect)
        {
            Thread.Sleep(2000);
            string code = "SM01";
            string code2 = "SS01";
